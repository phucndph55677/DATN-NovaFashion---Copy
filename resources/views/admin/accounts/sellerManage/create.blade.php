    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="fw-bold d-flex align-items-center">New Seller</h4>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.accounts.seller-manage.store') }}" method="post" enctype="multipart/form-data">
                           ...
                           <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Seller Name" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="phone" name="phone" placeholder="Enter Phone" value="{{ old('phone') }}">
                                @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="4" placeholder="Enter Address">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
