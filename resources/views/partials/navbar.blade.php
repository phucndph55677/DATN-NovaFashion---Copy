                    ...
                    <ul class="navbar-nav ms-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            ...
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="notification-dropdown">
                                <div class="card shadow-none m-0 border-0">
                                    <div class="p-3 card-header-border border-bottom">
                                    ...
                                    <div class="card-body overflow-auto card-header-border p-0 card-body-list"
                                        ...
                                        <ul class="dropdown-menu-1 overflow-auto list-style-1 mb-0">
                                            <li class="dropdown-item-1 float-none p-3 border-bottom">
                                                <div class="list-item d-flex justify-content-start align-items-start">
                                                    <div class="avatar">
                                                        <div class="avatar-img bg-danger avatar-20">
                                                            <span>
                                                    ...
                                                    <div class="list-style-detail ms-2 me-2">
                                                        <h6 class="fw-bold">Your order is placed</h6>
                                                        <p class="m-0">
                                                        ...
                                                        <p class="m-0 pt-1">
                                                            <small class="text-secondary d-flex">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="text-secondary me-2" width="15" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <li class="dropdown-item-1 float-none p-3  border-bottom">
                                                <div class="list-item d-flex justify-content-start align-items-start">
                                                    <div class="avatar">
                                                        <div class="avatar-img bg-success avatar-20">
                                                            <span><img class="avatar is-squared rounded-circle"
                                                                    src="https://templates.iqonic.design/datum-dist/laravel/public/images/user/2.jpg"
                                                                    alt="2.jpg"></span>
                                                        </div>
                                                    </div>
                                                    <div class="list-style-detail ms-2 me-2">
                                                        <h6 class="fw-bold">New message from cate</h6>
                                                        <p class="m-0">
                                                        ...
                                                        <p class="m-0">
                                                            <small class="text-secondary">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="text-secondary me-1" width="15" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            ...
                                            <li class="dropdown-item-1 float-none p-3 border-bottom">
                                                <div class="list-item d-flex justify-content-start align-items-start">
                                                    <div class="avatar">
                                                        <div class="avatar-img bg-warning avatar-20">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class="list-style-detail ms-2 me-2">
                                                        <h6 class="fw-bold">Your item is shipped</h6>
                                                        <p class="m-0">
                                    ...
                                    <div class="card-footer text-muted p-3">
                                        <p class="mb-0 text-primary text-center font-weight-bold">Show all notifications
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton2"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag001.png" class="img-fluid rounded-circle"
                                    ...
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                    href="#"><img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag-03.png"
                                                        alt="img-flaf" class="img-fluid me-2"
                                                        style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a>
                                            </li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                    href="#"><img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag-04.png"
                                                        alt="img-flaf" class="img-fluid me-2"
                                                        style="width: 15px;height: 15px;min-width: 15px;" />Italian</a>
                                            </li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                    href="#"><img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag-02.png"
                                                        alt="img-flaf" class="img-fluid me-2"
                                                        style="width: 15px;height: 15px;min-width: 15px;" />French</a>
                                            </li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                    href="#"><img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag-05.png"
                                                        alt="img-flaf" class="img-fluid me-2"
                                                        style="width: 15px;height: 15px;min-width: 15px;" />German</a>
                                            </li>
                                            <li class="dropdown-item-1 list-group-item  px-2"><a class="p-0"
                                                    href="#"><img src="https://templates.iqonic.design/datum-dist/laravel/public/images/Flag/flag-06.png"
                                                        alt="img-flaf" class="img-fluid me-2"
                        ...
                        <li class="nav-item nav-icon dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/userProfile">My Profile</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/userprofileedit">Edit Profile</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/useraccountsetting">Account Settings</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
