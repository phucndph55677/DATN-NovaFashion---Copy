        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                <li class="  sidebar-layout">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public" class="svg-icon">
                        <i class="">
                ...
                <li class=" sidebar-layout ">
                    <a href="{{ route('admin.banners.index') }}" class="svg-icon">
                ...
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/chatPage" class="svg-icon">
                        <i class="">
                    ...
                    <ul id="app6" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class=" sidebar-layout ">
                            <a href="https://templates.iqonic.design/datum-dist/laravel/public/error404"
                                ...
                                <span class="ms-2">Error 404</span>
                            </a>
                        </li>
                        <li class=" sidebar-layout ">
                            <a href="https://templates.iqonic.design/datum-dist/laravel/public/error500"
                                ...
                                <span class="ms-2">Error 500</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/comingsoon" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">Coming soon</span>
                    </a>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/maintenance" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">Maintenance</span>
                    </a>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/blankpage" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">Blank Page</span>
                    </a>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/faq" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">FAQ</span>
                    </a>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/pricing" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">Pricing</span>
                    </a>
                </li>
                <li class=" sidebar-layout ">
                    <a href="https://templates.iqonic.design/datum-dist/laravel/public/timeline" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        </i><span class="ms-2">Timeline</span>
                    </a>
                </li>
                <li class="px-3 pt-3 pb-2">
                    <span class="text-uppercase small fw-bold">Components</span>
                </li>
                <li class="sidebar-layout ">
                    <a href="#app2" class="collapsed svg-icon" data-bs-toggle="collapse" aria-expanded="false">
                        ...
                        <span class="ms-2">UI Elements</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon iq-arrow-right arrow-active"
                            width="15" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" id="iq-ui-1-0" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 90, 110; stroke-dashoffset: 0;"></path>
                                    </svg>
                            ...
                            <a href="https://templates.iqonic.design/datum-dist/laravel/public/ui/alerts"
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-1"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"
                                            style="stroke-dasharray: 56, 76; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-3"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 48, 68; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-4"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="{2}"
                                            ...
                                            style="stroke-dasharray: 72, 92; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-8"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 79, 99; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-9"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 133, 153; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-15"
                                        ...
                                        <path
                                            ...
                                            style="stroke-dasharray: 87, 107; stroke-dashoffset: 0;">
                                        </path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-16"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 63, 83; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-ui-1-17"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 19, 39; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" id="iq-ui-1-20" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 67, 87; stroke-dashoffset: 0;"></path>
                                    </svg>
                                ...
                                <i class="">
                                    <svg class="svg-icon" id="iq-ui-1-21" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            style="stroke-dasharray: 98, 118; stroke-dashoffset: 0;"></path>
                                    </svg>
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app3" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="sidebar-layout">
                            <a href="#form1" class="collapsed svg-icon" data-bs-toggle="collapse"
                                aria-expanded="false">
                                <i class="">
                                    <svg class="svg-icon" width="18" id="iq-form-1-1"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 18h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"
                                            style="stroke-dasharray: 61, 81; stroke-dashoffset: 0;"></path>
                                    </svg>
                                </i>
                ...
                <li class="sidebar-layout">
                    <a href="#form2" class="collapsed svg-icon" data-bs-toggle="collapse" aria-expanded="false">
                        <i class="">
                            <svg class="svg-icon" width="18" id="iq-user-1" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul id="app5" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                    <li class=" sidebar-layout ">
                        <a href="https://templates.iqonic.design/datum-dist/laravel/public/table/basictable"
                            ...
                            <span class="ms-2">Basic Tables</span>
                        </a>
                    </li>
                    <li class=" sidebar-layout ">
                        <a href="https://templates.iqonic.design/datum-dist/laravel/public/table/datatable"
                            ...
                            <span class="ms-2">Data Table</span>
                        </a>
                    </li>
                    <li class=" sidebar-layout ">
                        <a href="https://templates.iqonic.design/datum-dist/laravel/public/table/edittable"
                            ...
                            <span class="ms-2">Editable Table</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class=" sidebar-layout ">
                <a href="https://templates.iqonic.design/datum-dist/laravel/public/chart" class="svg-icon">
                    <i class="">
            ...
            <li class=" sidebar-layout mb-3 ">
                <a href="https://templates.iqonic.design/datum-dist/laravel/public/icon" class="svg-icon">
                    <i class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
