        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-2">
                ...
                <div class="col-lg-12 mb-3 d-flex justify-content-between">
                    <h4 class="fw-bold d-flex align-items-center">Update Product</h4>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="material" name="material" placeholder="Enter Material" value="{{ $product->material }}">
                                        @error('material')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
